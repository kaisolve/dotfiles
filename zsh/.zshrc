...
alias rm='rm -iv'
alias c="clear"
alias u="sudo pacman -Syu && pkill -RTMIN+8 dwmblocks"
...
alias vim="sudo nvim"
alias zone="timedatectl set-timezone "
alias time="sudo ln -sf /usr/share/zoneinfo/Europe/Berlin /etc/localtime"
...
alias zip="sudo tar -cf"
alias unzip="sudo tar -xf"
alias size="sudo du -sh"
alias Sys-lan="sudo localectl set-locale LANG="
